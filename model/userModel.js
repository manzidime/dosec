...
module.exports = class User {
    ...
    async createOne() {
        try {
            ...
            `, [this.data.nom.toUpperCase(), this.data.prenom.toUpperCase(), this.data.matricule, this.data.id_fonction,
                this.data.sexe,
                login.toLowerCase(),
                password, this.data.id_site, this.data.taxer, this.data.apurer, this.data.encoder,
                this.data.ordonnancer, this.data.administrer, this.data.rapport,
                this.data.imprimer,
                this.data.gerer, this.data.stocker, slug]);
    ...
    async updateOne(id) {
        try {
            ...
            const [rows] = await DB.query(`
                ...
                WHERE id_agent = ?
            `, [this.data.nom.toUpperCase(), this.data.prenom.toUpperCase(), this.data.matricule, this.data.id_fonction,
                this.data.sexe, this.data.taxer, this.data.apurer, this.data.encoder,
                this.data.ordonnancer, this.data.administrer, this.data.rapport,
                this.data.imprimer, this.data.gerer, this.data.stocker,login.toLowerCase(), id]);
