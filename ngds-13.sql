...
CREATE TABLE `taxation`  (
  ...
  `nom_receptionniste` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `telephone_receptioniste` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `montant` int(11) NULL DEFAULT NULL,
  ...
  CONSTRAINT `taxation_ibfk_5` FOREIGN KEY (`id_vehicule`) REFERENCES `vehicule` (`id_vehicule`) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
-- Records of taxation
-- ----------------------------
INSERT INTO `taxation` VALUES (3, 1, 1, 35, 'blabla', '2020-09-09 00:00:00', 18, 1, 'malondaa', '+243', 20000, 'CDF', 1, 2019.00, '2020-09-09 21:03:16', NULL, 'tax', 'false', '2020-09-09 17:11:38', 8, NULL, 20000, 'favorable');
INSERT INTO `taxation` VALUES (4, 1, 1, 41, 'blabla', '2020-09-09 00:00:00', 18, 1, 'malonda', '+243', 20000, 'USD', 1, 1968.00, '2020-09-11 00:18:27', 18, 'ord', 'true', '2020-09-09 17:12:43', 8, NULL, 20000, 'favorable');
INSERT INTO `taxation` VALUES (5, 1, 1, 41, 'blabla', '2020-09-09 00:00:00', 18, 1, 'malonda', '+243', 20000, 'USD', 1, 2000.00, '2020-09-10 23:37:34', 18, 'tax', 'false', '2020-09-09 20:48:39', 8, NULL, 20000, 'non favorable');
INSERT INTO `taxation` VALUES (6, 1, 1, 41, 'blabla', '2020-09-09 00:00:00', 18, 1, 'malonda', '+243', 20000, 'USD', 1, 2000.00, '2020-09-11 01:22:14', 18, 'ord', 'true', '2020-09-09 20:52:02', 8, NULL, 20000, 'favorable');
INSERT INTO `taxation` VALUES (7, 1, 1, 41, 'blabla', '2020-09-09 21:19:07', 18, 1, 'malonda', '+243', 20000, 'USD', 1, 2000.00, '2020-09-11 11:18:15', 18, 'ord', 'true', '2020-09-09 21:19:07', 8, NULL, 20000, 'favorable');
INSERT INTO `taxation` VALUES (8, 1, 1, 41, 'blabla', '2020-09-09 21:23:52', 18, 1, 'malonda', '+243', 20000, 'CDF', 1, 2019.00, '2020-09-09 21:26:46', 18, 'tax', 'false', '2020-09-09 21:23:52', 8, NULL, 20000, 'favorable');
INSERT INTO `taxation` VALUES (9, 1, 1, 41, 'blabla', '2020-09-10 02:23:49', 18, 1, 'malonda', '+243', 400000, 'USD', 2, 2000.00, '2020-09-11 01:04:10', 18, 'ord', 'true', '2020-09-10 02:23:49', 8, NULL, 400000, 'non favorable');
INSERT INTO `taxation` VALUES (10, 1, 1, 41, 'blabla', '2020-09-10 02:25:15', 18, 1, 'malondaaa', '+243', 400000, 'USD', 1, 2000.00, '2020-09-11 16:17:46', 18, 'ord', 'true', '2020-09-10 02:25:15', 8, NULL, 400000, 'favorable');
INSERT INTO `taxation` VALUES (11, 1, 1, 41, 'blabla', '2020-09-10 02:26:09', 18, 10, 'malonda', '+243', 400000, 'CDF', 2, 2000.00, '2020-09-11 00:08:36', 18, 'tax', 'true', '2020-09-10 02:26:09', 8, NULL, 400000, 'favorable');
INSERT INTO `taxation` VALUES (12, 1, 1, 41, 'blabla', '2020-09-10 11:13:52', 18, 10, 'malonda', '+243', 400000, 'CDF', NULL, 2000.00, NULL, NULL, 'tax', 'false', '2020-09-10 11:13:52', 8, NULL, 400000, 'favorable');
INSERT INTO `taxation` VALUES (13, 1, 1, 41, 'blabla', '2020-09-10 12:04:27', 18, 10, 'malonda', '+243', 25000, 'CDF', NULL, 2000.00, NULL, NULL, 'tax', 'false', '2020-09-10 12:04:27', 8, NULL, 25000, 'favorable');
INSERT INTO `taxation` VALUES (14, 1, 1, 41, 'blabla', '2020-09-10 12:18:43', 18, 10, 'malonda', '+243', 25000, 'CDF', 1, 2000.00, '2020-09-11 16:29:59', 18, 'ord', 'true', '2020-09-10 12:18:43', 8, NULL, 25000, 'favorable');
INSERT INTO `taxation` VALUES (15, 1, 1, 41, 'blabla', '2020-09-10 12:56:42', 18, 10, 'malonda', '+243', 25000, 'CDF', 1, 1800.00, '2020-09-10 22:17:35', 18, 'tax', 'true', '2020-09-10 12:56:42', 8, NULL, 25000, 'non favorable');
INSERT INTO `taxation` VALUES (16, 1, 9, 41, 'blabla', '2020-09-10 15:42:32', 18, 10, 'ekila nkumu nono', '+243', 25000, 'CDF', NULL, 1800.00, NULL, NULL, 'tax', 'true', '2020-09-10 15:42:32', 10, NULL, 25000, 'favorable');
INSERT INTO `taxation` VALUES (17, 1, 3, 41, NULL, '2020-09-11 10:27:52', 18, 9, 'ekila nkumu nono', '+243852058798', NULL, NULL, NULL, 1800.00, NULL, NULL, 'tax', 'true', '2020-09-11 10:27:52', 9, NULL, NULL, 'favorable');
INSERT INTO `taxation` VALUES (18, 1, 3, 41, NULL, '2020-09-11 11:02:03', 18, 9, 'ekila nkumu nono', 'zazazaz', 40000, 'CDF', NULL, 1800.00, NULL, NULL, 'tax', 'true', '2020-09-11 11:02:03', 9, NULL, NULL, 'favorable');
INSERT INTO `taxation` VALUES (19, 1, 3, 41, '000+19/TD/2020', '2020-09-11 11:06:04', 18, 9, 'ekila nkumu nono', 'zazazaz', 40000, 'CDF', NULL, 1800.00, NULL, NULL, 'tax', 'true', '2020-09-11 11:06:04', 9, NULL, NULL, 'favorable');
INSERT INTO `taxation` VALUES (20, 1, 1, 41, NULL, '2020-09-11 11:12:42', 18, 9, 'aaza', 'zazazaz', 40000, 'CDF', NULL, 1800.00, NULL, NULL, 'tax', 'true', '2020-09-11 11:12:42', 9, NULL, NULL, 'favorable');
INSERT INTO `taxation` VALUES (21, 1, 1, 41, NULL, '2020-09-11 11:16:49', 18, 9, 'aaza', 'zazazaz', 40000, 'CDF', NULL, 1800.00, NULL, NULL, 'tax', 'true', '2020-09-11 11:16:49', 9, NULL, NULL, 'favorable');
INSERT INTO `taxation` VALUES (22, 1, 1, 41, NULL, '2020-09-11 11:16:51', 18, 9, 'aaza', 'zazazaz', 40000, 'CDF', NULL, 1800.00, NULL, NULL, 'tax', 'true', '2020-09-11 11:16:51', 9, NULL, NULL, 'favorable');
INSERT INTO `taxation` VALUES (23, 1, 1, 41, '1023/TD/2020', '2020-09-11 11:17:18', 18, 9, 'aaza', 'zazazaz', 40000, 'CDF', NULL, 1800.00, NULL, NULL, 'tax', 'true', '2020-09-11 11:17:18', 9, NULL, NULL, 'favorable');
INSERT INTO `taxation` VALUES (24, 1, 15, 41, 'null', '2020-09-11 16:13:55', 18, 12, 'ekila nkumu nono', '+243', 65, 'USD', NULL, 1800.00, NULL, NULL, 'tax', 'true', '2020-09-11 16:13:55', 12, NULL, NULL, 'favorable');
INSERT INTO `taxation` VALUES (25, 1, 15, 41, '1025/TD/2020', '2020-09-11 19:32:37', 18, 9, 'ekila nkumu nono', '+243', 40000, 'CDF', NULL, 1800.00, NULL, NULL, 'tax', 'true', '2020-09-11 19:32:37', 9, NULL, NULL, 'favorable');
INSERT INTO `taxation` VALUES (26, 1, 15, 41, 'null', '2020-09-11 19:48:50', 18, 12, 'ekila nkumu nono', '+243', 65, 'USD', NULL, 1800.00, NULL, NULL, 'tax', 'true', '2020-09-11 19:48:50', 12, NULL, NULL, 'favorable');
...
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `v_all_tarif` AS select `tarif`.`montant` AS `montant`,`taxe`.`description` AS `code_taxe`,`tarif`.`id_taxe` AS `id_taxe`,`tarif`.`id_categorie` AS `id_categorie`,`tarif`.`id_article_budgetaire` AS `id_article_budgetaire`,`tarif`.`id_exercice` AS `id_exercice`,`exercice`.`annee` AS `exercice`,`tarif`.`devise` AS `devise` from ((`tarif` join `taxe` on(`tarif`.`id_taxe` = `taxe`.`id_taxe`)) join `exercice` on(`tarif`.`id_exercice` = `exercice`.`id_exercice`));

-- ----------------------------
-- View structure for v_all_taxation
-- ----------------------------
DROP VIEW IF EXISTS `v_all_taxation`;
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `v_all_taxation` AS select `taxation`.`id_taxation` AS `id_taxation`,`taxation`.`id_exercice` AS `id_exercice`,`taxation`.`id_taxe` AS `id_taxe`,`taxation`.`id_site` AS `id_site`,`taxation`.`devise` AS `devise`,`taxation`.`num_taxation` AS `num_taxation`,`taxation`.`date_taxation` AS `date_taxation`,`taxation`.`taux` AS `taux`,`taxation`.`id_agent` AS `id_agent`,`taxation`.`date_creation` AS `date_creation`,`taxation`.`active` AS `active`,`taxation`.`state` AS `state`,`taxation`.`id_compte` AS `id_compte`,`taxation`.`date_validation` AS `date_validation`,`taxation`.`id_validateur` AS `id_validateur`,`taxation`.`nom_receptionniste` AS `nom_receptionniste`,`taxation`.`telephone_receptioniste` AS `telephone_receptioniste`,`exercice`.`annee` AS `exercice`,`site`.`lieu` AS `lieu`,`taxateur`.`nom` AS `nom_taxateur`,`taxateur`.`prenom` AS `prenom_taxateur`,`validateur`.`nom` AS `nom_validateur`,`validateur`.`prenom` AS `prenom_validateur`,`taxation`.`id_contribuable` AS `id_contribuable`,`contribuable`.`nom` AS `redevable`,`taxation`.`montant` AS `montant`,`taxation`.`id_vehicule` AS `id_vehicule`,`vehicule`.`numero_chassis` AS `numero_chassis`,`vehicule`.`numero_plaque` AS `numero_plaque`,`vehicule`.`model` AS `model`,`vehicule`.`marque` AS `marque`,`vehicule`.`couleur` AS `couleur`,`taxe`.`description` AS `description`,`taxation`.`penalite` AS `penalite`,`taxation`.`montant_global` AS `montant_global`,`taxe`.`designation` AS `taxe` from (((((((`taxation` join `exercice` on(`taxation`.`id_exercice` = `exercice`.`id_exercice`)) join `taxe` on(`taxation`.`id_taxe` = `taxe`.`id_taxe`)) join `site` on(`taxation`.`id_site` = `site`.`id`)) left join `agent` `taxateur` on(`taxation`.`id_agent` = `taxateur`.`id_agent`)) left join `agent` `validateur` on(`taxation`.`id_validateur` = `validateur`.`id_agent`)) join `contribuable` on(`taxation`.`id_contribuable` = `contribuable`.`id_contribuable`)) join `vehicule` on(`taxation`.`id_vehicule` = `vehicule`.`id_vehicule`));
