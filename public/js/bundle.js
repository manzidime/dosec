...
},{}],"utils/alert.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.clearHtml = exports.alert = void 0;
...
//Alert
var alert = function alert(type, message, container) {
  var sta = type === 'alert-danger' ? 'Erreur!' : 'Opération réussie';
  var alert = "<div class=\"alert rounded-0 ".concat(type, " alert-dismissible fade show\" role=\"alert\">\n        <strong>").concat(sta, "</strong>").concat(message, "\n        <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\">\n            <span aria-hidden=\"true\">&times;</span>\n        </button>\n        </div>");
  container.insertAdjacentHTML('beforeend', alert);
};

exports.alert = alert;

var clearHtml = function clearHtml(container) {
  container.innerHTML = '';
};

exports.clearHtml = clearHtml;
},{"./dom":"utils/dom.js"}],"../../node_modules/axios/lib/helpers/bind.js":[function(require,module,exports) {
'use strict';
...
var login = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(_login, password) {
    var res;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            (0, _alert.clearHtml)(_dom.default.containerError);
            (0, _alert.alert)('alert-danger', _context.t0.response.data.message, _dom.default.containerError);
...
},{"axios":"../../node_modules/axios/index.js","./utils/alert":"utils/alert.js","./utils/dom":"utils/dom.js"}],"changePassword.js":[function(require,module,exports) {
"use strict";
...
var changePassword = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(oldPassword, password, passwordConfirm) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.clearHtml)(_dom.default.containerError);
              (0, _alert.alert)('alert-success', 'Votre mot de passe a été changé');

              _dom.default.formChangePassword.reset();
            }
          ...
          case 7:
            ...
            _context.t0 = _context["catch"](0);
            (0, _alert.clearHtml)(_dom.default.containerError);
            (0, _alert.alert)('alert-danger', _context.t0.response.data.message);
...
},{"axios":"../../node_modules/axios/index.js","./utils/dom":"utils/dom.js","./utils/alert":"utils/alert.js"}],"newPerson.js":[function(require,module,exports) {
"use strict";
...
var newPerson = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.alert)('alert-success', 'Personne créée', _dom.default.containerError);

              _dom.default.formNewPerson.reset();
            }
  ...
  return function newPerson(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.newPerson = newPerson;
},{"axios":"../../node_modules/axios/index.js","./utils/dom":"utils/dom.js","./utils/alert":"utils/alert.js"}],"updatePerson.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "/api/v1/contribuables/".concat(id),
              data: body
            });
...
},{"axios":"../../node_modules/axios/index.js","./utils/dom":"utils/dom.js","./utils/alert":"utils/alert.js"}],"desable.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.desableCar = exports.desable = void 0;
...
var desable = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'DELETE',
              url: "/api/v1/contribuables/disableOrActive/".concat(id),
              data: body
            });
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.clearHtml)(_dom.default.containerError);
              (0, _alert.alert)('alert-success', ' Personne desactivée!', _dom.default.containerError);

              _dom.default.rowData.forEach(function (el, index) {
  ...
  return function desable(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

exports.desable = desable;

var desableCar = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(body, id) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'DELETE',
              url: "/api/v1/vehicules/disableOrActive/".concat(id),
              data: body
            });
          ...
          case 7:
            ...
            (0, _alert.clearHtml)(_dom.default.containerError);
            (0, _alert.alert)('alert-danger', _context2.t0.response.data.message);
  ...
  return function desableCar(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();

exports.desableCar = desableCar;
},{"axios":"../../node_modules/axios/index.js","./utils/dom":"utils/dom.js","./utils/alert":"utils/alert.js"}],"newVehicule.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateVehicule = exports.newVehicule = void 0;
...
var newVehicule = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(body) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.clearHtml)(_dom.default.containerError);
              (0, _alert.alert)('alert-success', ' Vehicule crée!', _dom.default.containerError);
            }
  ...
  return function newVehicule(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.newVehicule = newVehicule;

var updateVehicule = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(body, id, index) {
    var res, container, _container;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "/api/v1/vehicules/".concat(id),
              data: body
            });
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              container = document.querySelector(".alert-update-vehicule-".concat(id));
              (0, _alert.clearHtml)(container);
              (0, _alert.alert)('alert-success', ' Vehicule mise à jour!', container);
            }
          ...
          case 7:
            _context2.prev = 7;
            _context2.t0 = _context2["catch"](0);
            _container = document.querySelector(".alert-update-vehicule-".concat(id));
            (0, _alert.clearHtml)(_container);
            (0, _alert.alert)('alert-danger', _context2.t0.response.data.message, _container);
  ...
  return function updateVehicule(_x2, _x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();

exports.updateVehicule = updateVehicule;
},{"axios":"../../node_modules/axios/index.js","./utils/dom":"utils/dom.js","./utils/alert":"utils/alert.js"}],"utils/select.js":[function(require,module,exports) {
"use strict";
...
var getTaxe2 = /*#__PURE__*/function () {
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              ...
              if (_dom.default.services.length !== 0) {
                _dom.default.services.forEach(function (el, index) {
  ...
  return function getTaxe2(_x) {
    return _ref.apply(this, arguments);
  };
}(); //Obtenir tous les vehicules d'un contribuable


exports.getTaxe2 = getTaxe2;
...
var getVehicules = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "/api/v1/vehicules/contribuable/".concat(id)
            });
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              vehicules = res.data.data.rows; //Les vehicules proviennent de la table vehicules
              ...
              if (_dom.default.vehicule) {
                _dom.default.vehicule.innerHTML = options;
              }
            }
  ...
  return function getVehicules(_x2) {
    return _ref2.apply(this, arguments);
  };
...
var communeByDistrict = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "/api/v1/communes/by-district/".concat(id)
            });
  ...
  return function communeByDistrict(_x3) {
    return _ref3.apply(this, arguments);
  };
}(); //Selectionner tous les quartiers d'une commune


exports.communeByDistrict = communeByDistrict;

var quartiersByCommune = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(id) {
    var res, quartier, options;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "/api/v1/quartiers/commune/".concat(id)
            });
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              quartier = res.data.data.rows;
              options = quartier.map(function (el) {
                return "<option value=\"".concat(el.id_quartier, "\">").concat(el.libelle_quartier, "</option>");
              }).join(' ');

              if (_dom.default.districtAr.length !== 0) {
                _dom.default.districtAr.forEach(function (el, index) {
                  (0, _alert.clearHtml)(_dom.default.quartierAr[index]);
                  _dom.default.quartierAr[index].innerHTML = options;
                });
              }

              if (_dom.default.quartier) {
                (0, _alert.clearHtml)(_dom.default.quartier);
                _dom.default.quartier.innerHTML = options;
              }
            }
  ...
  return function quartiersByCommune(_x4) {
    return _ref4.apply(this, arguments);
  };
}();

exports.quartiersByCommune = quartiersByCommune;

var articleBytype = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(id) {
    var res, articles, options;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "/api/v1/articles/type/".concat(id)
            });
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              ...
              options = articles.map(function (el, index) {
                return "<option value=\"".concat(el.id_article_budgetaire, "\">").concat(el.designation, "</option>");
              }).join(' ');

              if (_dom.default.types.length !== 0) {
                _dom.default.types.forEach(function (el, index) {
                  (0, _alert.clearHtml)(_dom.default.budge[index]);
                  _dom.default.budge[index].innerHTML = options;
                });
              }

              if (_dom.default.articles) {
                (0, _alert.clearHtml)(_dom.default.articles);
                _dom.default.articles.innerHTML = options;
              }
            }
  ...
  return function articleBytype(_x5) {
...
exports.validateTaxation = exports.desableTaxation = exports.updateTaxation = exports.newTaxation = void 0;
...
var newTaxation = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(body) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
  ...
  return function newTaxation(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.newTaxation = newTaxation;

var updateTaxation = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(body, id, index) {
    var res, container, _container;
        ...
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              ...
              (0, _alert.clearHtml)(container);
              (0, _alert.alert)('alert-success', ' Taxation mise à jour!', container);
            }
  ...
  return function updateTaxation(_x2, _x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();

exports.updateTaxation = updateTaxation;

var desableTaxation = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(body, id) {
    var res;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'DELETE',
              url: "/api/v1/taxation/disableOrActive/".concat(id),
              data: body
            });
          ...
          case 7:
            ...
            _context3.t0 = _context3["catch"](0);
            (0, _alert.clearHtml)(_dom.default.containerError);
            (0, _alert.alert)('alert-danger', _context3.t0.response.data.message);
  ...
  return function desableTaxation(_x5, _x6) {
    return _ref3.apply(this, arguments);
  };
}();

exports.desableTaxation = desableTaxation;

var validateTaxation = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(body, id, index) {
    var res, container, _container2;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "/api/v1/taxation/activateTaxation/".concat(id),
              data: body
            });
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              container = document.querySelectorAll('.container-alert')[index];
              (0, _alert.clearHtml)(container);
              (0, _alert.alert)('alert-success', 'Taxation validée', container);
            }
          ...
          case 7:
            _context4.prev = 7;
            _context4.t0 = _context4["catch"](0);
            _container2 = document.querySelectorAll('.container-alert')[index];
            (0, _alert.clearHtml)(_container2);
            (0, _alert.alert)('alert-danger', _context4.t0.response.data.message, _container2);
  ...
  return function validateTaxation(_x7, _x8, _x9) {
    return _ref4.apply(this, arguments);
  };
}();

exports.validateTaxation = validateTaxation;
},{"axios":"../../node_modules/axios/index.js","./utils/dom":"utils/dom.js","./utils/alert":"utils/alert.js"}],"attestation.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.newAttestation = void 0;
...
var newAttestation = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(body, container) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.alert)('alert-success', ' Attestation créée', container);
            }
          ...
          case 7:
            ...
            _context.t0 = _context["catch"](0);
            (0, _alert.clearHtml)(container);
            (0, _alert.alert)('alert-danger', _context.t0.response.data.message, container);
  ...
  return function newAttestation(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

exports.newAttestation = newAttestation;
},{"axios":"../../node_modules/axios/index.js","./utils/dom":"utils/dom.js","./utils/alert":"utils/alert.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var _newPerson = require("./newPerson");

var _updatePerson = require("./updatePerson");

var _desable = require("./desable");

var _newVehicule = require("./newVehicule");

var _select = require("./utils/select");

var _newTaxation = require("./newTaxation");
...
if (_dom.default.district) {
  _dom.default.district.addEventListener('change', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              idDistrict = _dom.default.district.value;
              _context.next = 3;
              return (0, _select.communeByDistrict)(idDistrict);
...
if (_dom.default.districtAr) {
  Array.from(_dom.default.districtAr).forEach(function (el) {
    el.addEventListener('change', /*#__PURE__*/function () {
...
if (_dom.default.commune) {
  _dom.default.commune.addEventListener('change', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
    var idCommune;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            idCommune = _dom.default.commune.value;
            _context3.next = 3;
            return (0, _select.quartiersByCommune)(idCommune);
...
if (_dom.default.commune) {
  _dom.default.commune.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
    var idCommune;
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
...
if (_dom.default.communeAr) {
  Array.from(_dom.default.communeAr).forEach(function (el) {
    el.addEventListener('change', /*#__PURE__*/function () {
    ...
    return regeneratorRuntime.wrap(function _callee7$(_context7) {
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            if (!_dom.default.type) {
              _context7.next = 4;
              break;
            }

            id = _dom.default.type.value;
            _context7.next = 4;
            return (0, _select.articleBytype)(id);
...
if (_dom.default.types) {
  Array.from(_dom.default.types).forEach(function (el) {
    el.addEventListener('change', /*#__PURE__*/function () {
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                idType = el.value;
                _context8.next = 3;
                return (0, _select.articleBytype)(idType);
...
if (_dom.default.formLogin) {
  _dom.default.formLogin.addEventListener('submit', /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context10.prev = _context10.next) {
            case 0:
              ...
              _context10.next = 3;
              return (0, _login.login)(_dom.default.login.value, _dom.default.password.value);
...
if (_dom.default.logout) {
  _dom.default.logout.addEventListener('click', _login.logout);
} //Change password


if (_dom.default.formChangePassword) {
  _dom.default.formChangePassword.addEventListener('submit', /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context11.prev = _context11.next) {
            case 0:
              event.preventDefault();
              _context11.next = 3;
              return (0, _changePassword.changePassword)(_dom.default.oldPassword.value, _dom.default.newPassword.value, _dom.default.confirmPassword.value);
...
if (_dom.default.formNewPerson) {
  _dom.default.formNewPerson.addEventListener('submit', /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context12.prev = _context12.next) {
            case 0:
              event.preventDefault();
              body = {
                nom: _dom.default.nomPersonne.value,
                telephone: _dom.default.telephone.value,
                ville: _dom.default.ville.value,
                id_district: _dom.default.district.value,
                id_commune: _dom.default.commune.value,
                id_quartier: _dom.default.quartier.value,
                avenue: _dom.default.avenue.value,
                numero: _dom.default.numero.value,
                observation: _dom.default.observation.value
              };
              _context12.next = 4;
              return (0, _newPerson.newPerson)(body);
...
if (_dom.default.formUpdatePerson) {
  Array.from(_dom.default.formUpdatePerson).forEach(function (el, index) {
    el.addEventListener('submit', /*#__PURE__*/function () {
      var _ref13 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee13(event) {
        var id, body;
...
if (_dom.default.btnDelete) {
  _dom.default.btnDelete.forEach(function (el, index) {
    el.addEventListener('click', /*#__PURE__*/function () {
      var _ref14 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee14(event) {
        var id, body;
          ...
          while (1) {
            switch (_context14.prev = _context14.next) {
              case 0:
                ...
                console.log(id);
                _context14.next = 6;
                return (0, _desable.desable)(body, id);
...
if (_dom.default.btnDeleteCar) {
  _dom.default.btnDeleteCar.forEach(function (el, index) {
    el.addEventListener('click', /*#__PURE__*/function () {
          ...
          while (1) {
            switch (_context15.prev = _context15.next) {
              case 0:
                ...
                _context15.next = 5;
                return (0, _desable.desableCar)(body, id);
...
if (_dom.default.fomrNewVehicule) {
  _dom.default.fomrNewVehicule.addEventListener('submit', /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context16.prev = _context16.next) {
            case 0:
              event.preventDefault();
              body = {
                id_article_budgetaire: _dom.default.articles.value,
                id_categorie: _dom.default.category.value,
                id_contribuable: _dom.default.contribuable.value,
                numero_chassis: _dom.default.chassis.value,
                numero_plaque: _dom.default.plaque.value,
                model: _dom.default.model.value,
                marque: _dom.default.marque.value,
                couleur: _dom.default.couleur.value,
                charge_utile: _dom.default.charge.value,
                mise_en_circulation: _dom.default.circulation.value
              };
              _context16.next = 4;
              return (0, _newVehicule.newVehicule)(body);
...
if (_dom.default.formUpdateV) {
  _dom.default.formUpdateV.forEach(function (el, index) {
    el.addEventListener('submit', /*#__PURE__*/function () {
      var _ref17 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee17(event) {
        var body, id;
          ...
          while (1) {
            switch (_context17.prev = _context17.next) {
              case 0:
                ...
                id = el.dataset.id;
                _context17.next = 5;
                return (0, _newVehicule.updateVehicule)(body, id, index);
...
if (_dom.default.taxe) {
  _dom.default.taxe.addEventListener('change', function () {
    ...
    console.log(_dom.default.taxe.value);
    _dom.default.contribuable.disabled = false;
    (0, _alert.clearHtml)(_dom.default.containerError);
  });
}
...
if (_dom.default.service) {
  _dom.default.service.addEventListener('change', /*#__PURE__*/function () {
      ...
      return regeneratorRuntime.wrap(function _callee18$(_context18) {
        while (1) {
          switch (_context18.prev = _context18.next) {
            case 0:
              idService = _dom.default.service.value;
              _context18.next = 3;
              return (0, _select.getTaxe2)(idService);
...
if (_dom.default.services) {
  _dom.default.services.forEach(function (el) {
    el.addEventListener('change', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee19() {
      var idService;
...
if (_dom.default.contribuable) {
  _dom.default.contribuable.addEventListener('change', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee20() {
    var idContribuable;
    return regeneratorRuntime.wrap(function _callee20$(_context20) {
      while (1) {
        switch (_context20.prev = _context20.next) {
          case 0:
            if (!_dom.default.taxe.value) {
              _dom.default.contribuable.disabled = true;
              (0, _alert.clearHtml)(_dom.default.containerError);
              (0, _alert.alert)('alert-danger', 'Veillez d\'abord choisir la taxe', _dom.default.containerError);
            }

            idContribuable = _dom.default.contribuable.value;
            _context20.next = 4;
            return (0, _select.getVehicules)(idContribuable);
...
if (_dom.default.contribuable) {
  _dom.default.contribuable.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee21() {
...
if (_dom.default.contribuables) {
  _dom.default.contribuables.forEach(function (el) {
    el.addEventListener('change', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee22() {
      var idContribuable;
      return regeneratorRuntime.wrap(function _callee22$(_context22) {
        while (1) {
          switch (_context22.prev = _context22.next) {
            case 0:
              idContribuable = el.value;
              _context22.next = 3;
              return (0, _select.getVehicules)(idContribuable);
          ...
          switch (_context23.prev = _context23.next) {
            case 0:
              ...
              body = {
                ...
                penalite: _dom.default.penalite.value
              };
...
if (_dom.default.btnEdit) {
  _dom.default.btnEdit.forEach( /*#__PURE__*/function () {
    var _ref24 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee25(el, index) {
      return regeneratorRuntime.wrap(function _callee25$(_context25) {
        while (1) {
          switch (_context25.prev = _context25.next) {
            case 0:
              el.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee24() {
                var id;
          ...
          while (1) {
            switch (_context26.prev = _context26.next) {
              case 0:
                event.preventDefault();
                body = {
                  id_taxe: _dom.default.taxes[index].value,
                  nom_receptionniste: _dom.default.nomReceptionnistes[index].value,
                  telephone_receptioniste: _dom.default.telephoneReceptionnistes[index].value,
                  id_vehicule: _dom.default.vehicules[index].value,
...
if (_dom.default.formNewAttestation) {
  Array.from(_dom.default.formNewAttestation).forEach(function (el, index) {
    el.addEventListener('submit', /*#__PURE__*/function () {
          ...
          while (1) {
            switch (_context29.prev = _context29.next) {
              case 0:
                ...
                container = document.querySelector(".container-alert-".concat(id));
                ...
                (0, _alert.alert)('alert-danger', "Cet attestation n'est pas valid\xE9 compte tenu de votre avis defavorable", container);
                return _context29.abrupt("return", false);

              case 7:
                _context29.next = 9;
                return (0, _attestation.newAttestation)(body, container);
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "8874" + '/');
